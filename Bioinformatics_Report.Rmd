---
title: 'Effect of different storage conditions on the development of microorganisms in ground beef is unknown'
author: "Kris Choi"
...
values for each sample using Qubit Fluorometer (Figure 1). The data
...
and 6 respectively, indicating no DNA separated from the sample (Figure 2).
...
fragment size according to EZ Load 1 kb Molecular Ruler (Figure 2a).
...
**Figure 2a:** Ladder used in lane 1 (EZ Load 1 kb Molecular Ruler #1708355).
...
abundances with no other variations (Figure 3). In fact, 1,000 was an
...
hypothesis (p = 0.20). Similarly in Figure 4, a broad variation of the
...
and 1 seemingly failed data (Figure 5). I used the 3 successful data after
trimming to create Maximum Likelihood and Bayesian phylogenetic trees
with *Thermus aquaticus* as an outgroup (Figure 6, 7) and found a strong
...
**Figure 5:** Sanger sequencing data for each sample analyzed by Geneious
Prime.
...
**Figure 6:** Bayesian phylogenetic tree constructed by MrBayes.


![](data/images/Phylogenies/Sanger_PhyML_phylogenies.png)

**Figure 7:** Maximum Likelihood phylogeny constructed by PhyML.
...
identifications with strong evidence to support the data (Figure 8).
...
**Figure 8:** Identification of each sample conducted by BLAST.
...
which corresponded to the failed Sanger sequencing data, and the faded
band for Sample #3 corresponded to the seemingly failed Sanger sequencing data. 
...
(Figure 8). All of the samples except for the complete failures was
