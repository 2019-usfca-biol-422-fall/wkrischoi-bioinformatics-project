...
major taxa for sample 1B to 3B while 1A identified to be *Bos mutus*, the
domestic yak (Figure 8B).
...
observed from cultured samples, *Acinetobacter baumannii*, *Hafnia paralvei*,
and *Staphylococcus saprophyticus* were also identified from culture-free
samples but no *Kocuria rhizophila*.
