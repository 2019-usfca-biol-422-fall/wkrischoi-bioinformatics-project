...
in it.  However, I found a small band only in lane 6 and did not observe
any bands in other lnaes. The gel image showed that there was no DNA
separated except for the sample #3B in lane 6 (Figure 6B).
...
**Figure 6B:** Gel image of culture-free samples. Samples from 1A to 3B are
