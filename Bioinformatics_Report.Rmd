...
values for each sample using Qubit Fluorometer (Figure 2A). The data
...
and 6 respectively, indicating no DNA separated from the sample (Figure 2B).
...
fragment size according to EZ Load 1 kb Molecular Ruler (Figure 2C).
...
**Figure 2A:** DNA concentration values for culture samples. Sample ID 1 was
