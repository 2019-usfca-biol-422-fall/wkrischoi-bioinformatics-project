...
As mentioned earlier, the raw sequence data for the cultured samples
was trimmed manually by the software called Geneious Prime. 
...
**Figure 7:** Number of sequences before and after removing bad sequences
using Trimmomatic.
