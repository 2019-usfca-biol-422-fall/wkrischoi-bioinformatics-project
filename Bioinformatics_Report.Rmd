...
hygienic environment for slaughtering has been developed
to ensure safe and suitable human consumption and different research in
enhancing antimicrobial meat packaging has been actively performed to
deliver longer shelf life [@mcmillin2017advancements]. Along with the
advancement in meat processing technologies, the temperature of storage has
also been emphasized as a key factor in avoiding meat spoilage because
meat is prone to deterioration [@doulgeraki2012spoilage].
...
further analysis and identified each sample using BLAST. 
4 out of 6 samples
were succesfully identified from culture-based samples
Out of 3 replicas, 2 samples from room temperature storage condition
...
pigmentation while sample 3 completely turned to brown (Figure 1B).
...
surface when subsampled. As a consequence, highly concentrated stock
